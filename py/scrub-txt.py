...
filename="C:/Users/rajar/srimad_bhaghavatham/sanskrit/canto"+canto.zfill(2)+"/chapter" + adyayam_number.zfill(2) + ".txt"
...
data=re.sub(r"(.*)( लगते | तुम्हारी | आपकी | आपका | मुझे | कुछ | अपनी | कर लो | करो | उतना | गिरते | सुनकर | हरा-भरा | ले लेते| लगाया | किसीका | इसी | बहुत | करती | इसमें | ओर | ही |कहा | बड़े |लगे )(.*)\n", "", data)
while re.search(r" \n", data):
  data=re.sub(r" \n", r'\n', data)
while re.search(r"\n\n\n", data):
  data=re.sub(r"\n\n\n", r"\n\n", data)
