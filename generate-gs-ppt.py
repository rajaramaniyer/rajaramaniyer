...
RSFOLDER=USERPROFILE + "\\books\\srisrianna\\govindashathakam\\"
IMGFILE=USERPROFILE + "\\Pictures\\001 govindashathakam\\YouTube\\" + SONG_PREFIX + ".*"
SLIDEIMGFILE=USERPROFILE + "\\Pictures\\001 govindashathakam\\YouTube\\" + SONG_PREFIX
IMGFILES=glob.glob(IMGFILE)
PPTFILE=USERPROFILE + "\\Videos\\govindashathakam\\" + SONG_PREFIX + ".pptm"
TEMPLATEFILE=USERPROFILE + "\\Videos\\govindashathakam\\template.pptm"
...
p = subprocess.Popen(["C:/Program Files/Microsoft Office 15/root/office15/POWERPNT.EXE", "/M", PPTFILE, "GSSave_PowerPoint_Slide_as_Images"])
